...
/*关闭dialog事件*/
$(function(){
    $('.dialog .dialog-header .fa-close').click(function(){
        console.log('3432');
        $(this).parent().parent().parent().parent().stop(true,false).fadeToggle();
        $(this).parent().parent().parent().stop(true,false).slideToggle();
    })
})

function openDialog(id){
    $('#'+id).stop(true,false).fadeToggle();
    $('#'+id+' .dialog-container').stop(true,false).slideToggle();
}