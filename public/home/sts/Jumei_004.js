    ...
    clickMap.fn = clickMap.prototype = {
            ...
            click : function(type) {
                if((location.href.match(new RegExp(domain_reg)).length > 0 || this.domain_this == "all") && this.isOpen_this) {
                    ...
                    clk.uid = this.isValid(this.getCookie("cs_logined_uid"))?this.getCookie("cs_logined_uid"):"0";
            ...
            getUid : function() {
                ...
                if(null != uid && 0 != uid && "" != uid && "null" != uid && "NULL" != uid) {
                    this.setHttpCookie("cs_logined_uid", uid);
                }
