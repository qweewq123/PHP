...
<div class="modal fade" id="exampleModal" tabindex="10000" role="dialog" aria-labelledby="exampleModalLabel">
  <form class="form-horizontal" action="<?php echo U('goods/index');?>"  method="get" onsubmit="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-lg-3 col-lg-offset-1" for="username">商品名：</label>
                        <div class="col-lg-6">
                            <input type="text"  class="form-control"  maxlength="32" name="proname" id="username" value="<?php echo ($_GET['proname']); ?>"/>
                        </div>
                 </div>
			...
			<div class="widget">
				<div class="widget-head">
					<div class="pull-left col-md-8">
						<form class="form-inline" action="<?php echo U('goods/index');?>" method="get">
							<div class="row">
		                       ...
		                       =
											<button type="button" onclick="window.location='<?php echo U('goods/add');?>'"
												class="btn btn-info">
												<i class="icon-plus"></i>&nbsp;新增
											</button>
											<button type="button"
												onclick="window.location='<?php echo U('goods/index');?>'"
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
								...
								<td><?php echo ($vo["price"]); ?></td>
								 ...
								 <?php elseif($vo["color"] == 2): ?>
								  ...
								  <?php else: ?>
								  <td>无</td><?php endif; ?>
								 	<?php if($vo["color1"] == 1): ?><td>白色</td>
								 <?php elseif($vo["color1"] == 2): ?>
								  <td>蓝色</td>
								  <?php elseif($vo["color1"] == 3): ?>
								  <td>金色</td>
								  <?php else: ?>
								  <td>无</td><?php endif; ?>
								 <?php if($vo["color2"] == 1): ?><td>白色</td>
								 <?php elseif($vo["color2"] == 2): ?>
								  <td>蓝色</td>
								  <?php elseif($vo["color2"] == 3): ?>
								  <td>金色</td>
								  <?php else: ?>
								  <td>无</td><?php endif; ?>
								<td><?php echo ($vo["store"]); ?></td>
								<?php if($vo["state"] == 1): ?><td>新品</td>
								...
								<?php if($vo["version"] == 1): ?><td>网通版</td>
								 <?php elseif($vo["version"] == 2): ?>
								  ...
								  <?php else: ?>
								  <td>无</td><?php endif; ?>
								 <?php if($vo["version1"] == 1): ?><td>网通版</td>
								 <?php elseif($vo["version1"] == 2): ?>
								  <td>电信版</td>
								  <?php elseif($vo["version1"] == 3): ?>
								  <td>公开版</td>
								  <?php else: ?>
								  <td>无</td><?php endif; ?>
								 <?php if($vo["version2"] == 1): ?><td>网通版</td>
								 <?php elseif($vo["version2"] == 2): ?>
								  <td>电信版</td>
								  <?php elseif($vo["version2"] == 3): ?>
								  <td>公开版</td>
								  <?php else: ?>
								  <td>无</td><?php endif; ?>
								<?php if($vo["rom"] == 1): ?><td>16GB</td>
								 <?php elseif($vo["rom"] == 2): ?>
								  <td>32GB</td>
								  
								  <?php else: ?>
								  <td>无</td><?php endif; ?>
								 <?php if($vo["rom1"] == 1): ?><td>16GB</td>
								 <?php elseif($vo["rom1"] == 2): ?>
								  <td>32GB</td>
								...
								<td>
										<a class="btn btn-xs btn-warning" href="/index.php/admin/goods/goodsedit/id/<?php echo ($vo['id']); ?>" 
										  title="修改">
												<i class="icon-edit">修改</i>
									    </a>
								       &nbsp 
										<a class="btn btn-xs btn-warning" href="/index.php/admin/goods/goodsdel/id/<?php echo ($vo['id']); ?>" 
