			...
			<div class="widget">
				<div class="widget-head">
					<div class="pull-left col-md-8">
						<form class="form-inline" action="<?php echo U('Power/index');?>" method="get">
							<div class="row">
								<div class="input-group col-lg-10">
									 ...
									 <span class="input-group-btn">
											...
											<button type="button" onclick="window.location='<?php echo U('Power/powerAdd');?>'"
												class="btn btn-info">
				...
				<div class="widget-content">
					<table class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								<th><i class="icon-align-left"></i> 权利PID</th>
								<th><i class="icon-user"></i> 权利</th>
						...
						<tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
								...
								<td>
										...
										<a class="btn btn-xs btn-warning" href="/index.php/admin/power/powerEdit/pid/<?php echo ($vo['pid']); ?>" 
										 title="修改">
												<i class="icon-edit">修改</i>
									    </a>
								       &nbsp 
										<a class="btn btn-xs btn-warning" href="/index.php/admin/power/powerDel/pid/<?php echo ($vo['pid']); ?>" 
