							...
							<div class="row">
								<div class="input-group col-lg-10">
									 ...
									 <span class="input-group-btn">
											...
											<button type="button" onclick="window.location='<?php echo U('Img/imgAdd');?>'"
												class="btn btn-info">
												<i class="icon-plus"></i>&nbsp;新增
											</button>
											<button type="button" onclick="window.location='<?php echo U('Img/imgEdit');?>'"
												class="btn btn-info">
					...
					<table class="table table-striped table-bordered table-hover" >
						...
						<tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                <td>
                                	<img src="/Public/Uploads/<?php echo ($vo["img1"]); ?>" style="width:200px;height:150;">
                                </td>
								<td>
									<img src="/Public/Uploads/<?php echo ($vo["img2"]); ?>" style="width:200px;height:150;">
								</td>
								<td>
									<img src="/Public/Uploads/<?php echo ($vo["img3"]); ?>" style="width:200px;height:150;">
								</td>
								<td>
									<img src="/Public/Uploads/<?php echo ($vo["img4"]); ?>" style="width:200px;height:150;">
								</td>
								<td>
									<img src="/Public/Uploads/<?php echo ($vo["img5"]); ?>" style="width:200px;height:150;">
								</td>
