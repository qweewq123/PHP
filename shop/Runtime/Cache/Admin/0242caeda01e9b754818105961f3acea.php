			...
			<div class="widget">
				<div class="widget-head">
					<div class="pull-left col-md-8">
						<form class="form-inline" action="<?php echo U('Upower/index');?>" method="get">
							<div class="row">
								<div class="input-group col-lg-10">
									 ...
									 <span class="input-group-btn">
											...
											<button type="button"
												onclick="window.location='<?php echo U('Upower/index');?>'"
				...
				<div class="widget-content">
					<table class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								<th><i class="icon-align-left"></i> 用户ID</th>
								<th><i class="icon-user"></i> 用户名</th>
							    <th><i class="icon-user"></i> 户名角色ID</th>
						...
						<tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
							    ...
							    <td><?php echo ($vo["ur"]); ?></td>
								<td>
									
										<a class="btn btn-xs btn-warning" href="/index.php/admin/upower/UpowerEdit/id/<?php echo ($vo['id']); ?>" 
										 title="修改">
