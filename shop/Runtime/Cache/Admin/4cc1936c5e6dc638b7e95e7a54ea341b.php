...
<div class="modal fade" id="exampleModal" tabindex="10000" role="dialog" aria-labelledby="exampleModalLabel">
  <form class="form-horizontal" action="<?php echo U('Vipdetails/index');?>"  method="get" onsubmit="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-lg-3 col-lg-offset-1" for="username">用户姓名：</label>
                        <div class="col-lg-6">
			...
			<div class="widget">
				...
				<div class="widget-content">
					<table class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								<th><i class="icon-align-left"></i> UID</th>
						...
						<tbody>
                            <?php if(is_array($row)): foreach($row as $key=>$vo): ?><tr>
								...
								<td><?php echo ($vo["province"]); echo ($vo["city"]); echo ($vo["county"]); echo ($vo["xiang"]); echo ($vo["address"]); ?></td>
								...
								<td>
								       ...
								       &nbsp 
										<a class="btn btn-xs btn-warning" href="/index.php/admin/vipdetails/VipdetailsDel/id/<?php echo ($vo['id']); ?>" 
