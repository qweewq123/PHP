        ...
        <div class="container-fluid">
            <div class="widget wred">
                <div class="widget-head">
                    <div class="pull-left">用户信息修改</div>
                ...
                <div class="widget-content">
                    <div class="padd">
                        <div class="form profile">
                            ...
                            <form class="form-horizontal" action="/index.php/admin/user/userUpdate" id="saveUserFrom" method="post" onsubmit="">
                                <input type="hidden" name="id" value="<?php echo ($data['id']); ?>" />
                            	<div class="form-group">
                                    <label class="control-label col-lg-3 col-lg-offset-1" for="username">用户名</label>
                                    <div class="col-lg-3">
                                        <input type="text"  class="form-control"  maxlength="32" name="username" id="username" value="<?php echo ($data['username']); ?>"/>
                                    </div>
                                    <b class="text-left" style="color:red">*</b>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-lg-3 col-lg-offset-1">状态</label>
                                    <div class="col-lg-3">
                                        <select class="form-control" name="state">
                                            <?php if($data['state'] == 1): ?><option value="1" name="state" selected>前台用户</option>
                                               <option value="2" name="state">后台用户</option>
                                            <?php else: ?> 
                                               <option value="1" name="state">前台用户</option>
                                               <option value="2" name="state" selected>后台用户</option><?php endif; ?>
                                            <!-- <option value="1" name="state">前台用户</option>
                                            <option value="2" name="state">管理员</option> -->
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group" >
                                    <label class="control-label col-lg-3 col-lg-offset-1">性别</label>
                                    <div class="col-lg-3">
                                        <select class="form-control" name="sex">
                                            <?php if($data['sex'] == m): ?><option value="m" name="sex" selected>男</option>
                                            <option value="w" name="sex">女</option>
                                            <?php else: ?> 
                                               <option value="m" name="sex">男</option>
                                            <option value="w" name="sex" selected>女</option><?php endif; ?>
                                            <!-- <option value="m" name="sex">男</option>
                                            <option value="w" name="sex">女</option> -->
                                        </select>
                                    </div>
