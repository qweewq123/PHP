...
<div class="modal fade" id="exampleModal" tabindex="10000" role="dialog" aria-labelledby="exampleModalLabel">
  <form class="form-horizontal" action="<?php echo U('Connection/index');?>"  method="get" onsubmit="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-lg-3 col-lg-offset-1" for="name">用户名：</label>
                        <div class="col-lg-6">
                            <input type="text"  class="form-control"  maxlength="32" name="name" id="name" value="<?php echo ($_GET['name']); ?>"/>
                        </div>
                 </div>
			...
			<div class="widget">
				<div class="widget-head">
					<div class="pull-left col-md-8">
						<form class="form-inline" action="<?php echo U('connection/index');?>" method="get">
							<div class="row">
								<div class="input-group col-lg-10">
									 ...
									 <span class="input-group-btn">
											...
											<button type="button" onclick="window.location='<?php echo U('Connection/connectionAdd');?>'"
												class="btn btn-info">
												<i class="icon-plus"></i>&nbsp;新增
											</button>
											<button type="button"
												onclick="window.location='<?php echo U('Connection/index');?>'"
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
								...
								<td><?php echo ($vo["www"]); ?></td>
								

								<td>
							
										<a class="btn btn-xs btn-warning" href="/index.php/admin/connection/connectionEdit/id/<?php echo ($vo['id']); ?>" 
										  title="修改">
												<i class="icon-edit">修改</i>
									    </a>
								       &nbsp 
										<a class="btn btn-xs btn-warning" href="/index.php/admin/connection/connectionDel/id/<?php echo ($vo['id']); ?>" 
