...
<div class="modal fade" id="exampleModal" tabindex="10000" role="dialog" aria-labelledby="exampleModalLabel">
  <form class="form-horizontal" action="<?php echo U('User/index');?>"  method="get" onsubmit="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-lg-3 col-lg-offset-1" for="username">用户名：</label>
                        <div class="col-lg-6">
                            <input type="text"  class="form-control"  maxlength="32" name="username" id="username" value="<?php echo ($_GET['username']); ?>"/>
                        </div>
                 </div>
             		   <!--     <div class="form-group row">
                        <label class="control-label col-lg-3 col-lg-offset-1" for="username">权限：</label>
                        <div class="col-lg-6"> 
                            <input type="radio"  <?php echo I('get.auth') ==1 ? 'checked' :'';?>  style="vertical-align:middle"  name="auth"  value="0"  id="id_card" value="<?php echo ($_GET['id_card']); ?>"/>&nbsp;注册用户
                            <input type="radio"  style="vertical-align:middle"   name="auth"  value="1"  id="id_card" value="<?php echo ($_GET['id_card']); ?>"/>&nbsp;管理员
                        </div>
                    </div> -->
            </div>
						...
						<form class="form-inline" action="<?php echo U('User/index');?>" method="get">
							<div class="row">
								<div class="input-group col-lg-10">
		                         ...
		                         <!--            <button type="button"
												onclick="window.location='<?php echo U('User/index');?>'"
												class="btn btn-danger">
		                                        <i class="icon-trash"></i>&nbsp;清除
		                                    </button> -->
											<button type="button" onclick="window.location='<?php echo U('User/userAdd');?>'"
												class="btn btn-info">
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
								...
								<td><?php echo ($vo['sex'] == m ? '男' : '女'); ?></td>
								<td><?php echo ($vo['addtime']); ?></td>
								<td><?php echo ($vo['state'] == 1 ? '前台用户' : '后台用户'); ?></td>

								<td>
									<a class="btn btn-xs btn-warning" href="/index.php/admin/Vipdetails/index/id/<?php echo ($vo['id']); ?>" 
										 title="详情">
												<i class="icon-edit">详情</i>
									    </a>&nbsp 
										<a class="btn btn-xs btn-warning" href="/index.php/admin/user/userEdit/id/<?php echo ($vo['id']); ?>" 
										 title="修改">
												<i class="icon-edit">修改</i>
									    </a>
								       &nbsp 
										<a class="btn btn-xs btn-warning" href="/index.php/admin/user/userDel/id/<?php echo ($vo['id']); ?>" 
