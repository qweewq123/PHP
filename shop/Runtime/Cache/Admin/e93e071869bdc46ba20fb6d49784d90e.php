        ...
        <div class="container-fluid">
            <div class="widget wred">
                <div class="widget-head">
                    <div class="pull-left">添加顶级分类</div>
                ...
                <div class="widget-content">
                    <div class="padd">
                        <div class="form profile">
                            ...
                            <form class="form-horizontal" action="/index.php/admin/cates/catesinsert" id="saveUserFrom" method="post" onsubmit="">
                                <div class="form-group">
                                    <label class="control-label col-lg-3 col-lg-offset-1" for="username">顶级分类</label>
                                    <div class="col-lg-3">
                                        <input type="text"  class="form-control"  maxlength="32" name="catename" id="username" value=""/>
                                    </div>
