			...
			<div class="widget">
				<div class="widget-head">
					<div class="pull-left col-md-8">
						<form class="form-inline" action="<?php echo U('Role/index');?>" method="get">
							<div class="row">
								<div class="input-group col-lg-10">
									 ...
									 <span class="input-group-btn">
											...
											<button type="button" onclick="window.location='<?php echo U('Role/roleAdd');?>'"
												class="btn btn-info">
												<i class="icon-plus"></i>&nbsp;新增
											</button>
											<button type="button"
												onclick="window.location='<?php echo U('Role/index');?>'"
				...
				<div class="widget-content">
					<table class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								<th><i class="icon-align-left"></i> 角色RID</th>
								<th><i class="icon-user"></i> 角色</th>
						...
						<tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
								...
								<td>
										...
										<a class="btn btn-xs btn-warning" href="/index.php/admin/role/roleEdit/rid/<?php echo ($vo['rid']); ?>" 
										 title="修改">
												<i class="icon-edit">修改</i>
									    </a>
								       &nbsp 
										<a class="btn btn-xs btn-warning" href="/index.php/admin/role/roleDel/rid/<?php echo ($vo['rid']); ?>" 
