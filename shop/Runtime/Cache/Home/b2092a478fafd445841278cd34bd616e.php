...
<div class="right-content f-fr" id="order" style="display:block;">
            <div class="order-main">
                ...
                <div class="list-head" style="background:#ccc;width:190px;margin-top:-21px">
                    <ul class="clearfix">
                        <li class="w501" style="color:#fff;width:190px">收藏的商品</li>
                  
                    </ul>
                </div>
                
                <div class="list-head" style="background:#fff">

              <ul class="clearfix" style="position:absolute" >
              <?php if(is_array($res)): foreach($res as $key=>$vo): ?><a href="/index.php/home/Details/index/id/<?php echo ($vo["proid"]); ?>"><li class="w501" style="width:190px"><?php echo ($vo["proname"]); ?><img width="180" src="/Public/Uploads/<?php echo ($vo["image1"]); ?>" alt=""></li></a>
                        <a href="/index.php/home/collection/del/id/<?php echo ($vo["id"]); ?>"><li><input type="button" value="取消" style="background:#3EADFC;border:0px;color:#fff;width:70px;"></li></a><?php endforeach; endif; ?>
                    </ul>
